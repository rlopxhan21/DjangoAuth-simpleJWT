...
from .views import RegisterationView, MyTokenObtainPairView, ProfileDataView, SingleProfileDataView, BasicInfoChangeView, PasswordChangeView, ProfileImageView

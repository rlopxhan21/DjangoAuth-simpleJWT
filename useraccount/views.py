...
from .serializers import RegistrationSerializer, MyTokenObtainPairSerializer, ProfileDataSerializer, BasicInfoChangeSerializer, PasswordChangeSerizlier
...
class PasswordChangeView(mixins.UpdateModelMixin, generics.GenericAPIView):
    ...
    serializer_class = PasswordChangeSerizlier
    queryset = User.objects.all()
    permission_classes= [SuperUserorOwnerorReadOnly]
